...
public class AppExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> handleBusinessException(AppException businessEx,
        WebRequest request) {
    ...
    private ErrorMessageDto buildResponse(AppException businessEx, WebRequest request) {
    ...
    //            WebRequest request) {
    //        errorMessage = messageSource.getMessage("error.bad.request", null, Locale.ENGLISH);
